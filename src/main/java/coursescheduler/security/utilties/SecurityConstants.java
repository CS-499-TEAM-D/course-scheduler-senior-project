...
public final class SecurityConstants {
    ...
    public static final String CREDENTIALS_SHEET = "CREDS!";
    public static final String USERNAME_COLUMN = "A";
    public static final String PASSWORD_COLUMN = "B";
    public static final String ROLE_COLUMN = "C";
